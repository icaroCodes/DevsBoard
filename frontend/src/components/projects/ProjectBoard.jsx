...
function TaskModal({ initial, onClose, onSubmit }) {
 ...
 <div>
 <label className="text-[11px] font-semibold tracking-normal text-[#86868B]">Título*</label>
 ...
 <div>
 <label className="text-[11px] font-semibold tracking-normal text-[#86868B]">Descrição</label>
 ...
 <div>
 <label className="text-[11px] font-semibold tracking-normal text-[#86868B]">Status</label>

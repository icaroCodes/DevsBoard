  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
      ...
      <motion.form onSubmit={submit} onClick={e => e.stopPropagation()}
        ...
        <div>
          <label className="text-[11px] font-semibold uppercase tracking-wider text-[#86868B]">Nome*</label>
        ...
        {typeMeta.needsImage && (
          <div>
            <label className="text-[11px] font-semibold uppercase tracking-wider text-[#86868B]">Imagem{typeMeta.needsImage && !url ? '*' : ''}</label>
            <div
        ...
        <div>
          <label className="text-[11px] font-semibold uppercase tracking-wider text-[#86868B]">
              ...
              return (
                <motion.div key={a.id} layout
                  ...
                  <div
                    ...
                    <div className={`absolute top-2 left-2 flex items-center gap-1 px-1.5 py-0.5 rounded-full backdrop-blur-md text-[10px] font-bold uppercase tracking-wider ${style.soft}`}>

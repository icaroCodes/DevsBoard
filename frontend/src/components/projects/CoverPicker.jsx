...
export default function CoverPicker({ value, onChange, onClear, anchorRef, align ='right', trigger }) {
 ...
 <div>
 <p className="text-[10px] font-bold text-[#63646B] px-1 pb-1.5">Gradientes</p>
 ...
 <div>
 <p className="text-[10px] font-bold text-[#63646B] px-1 pb-1.5">Cores sólidas</p>
 ...
 <div>
 <p className="text-[10px] font-bold text-[#63646B] px-1 pb-1.5">Paleta</p>
 ...
 <div>
 <p className="text-[10px] font-bold text-[#63646B] px-1 pb-1.5">Hex</p>
 <form
 ...
 placeholder="#1F1F1F"
 spellCheck={false}
 className="flex-1 bg-white/[0.04] border border-white/[0.06] rounded-[7px] px-3 py-2 text-[13px] font-mono text-[#F5F5F7] placeholder:text-[#63646B] outline-none focus:border-white/[0.14] tracking-normal"
 />
 <button
 type="submit"
 disabled={!isHex(hex)}

...
export default function PublicProfile() {
 ...
 <div className="text-[11px] font-bold text-zinc-500 mb-1.5 flex items-center gap-1.5">
 ...
 <div className="text-[11px] font-bold text-orange-500 mb-1.5 flex items-center gap-1.5">
 ...
 <span className="text-3xl font-semibold text-white tracking-tight">{p.stats.achievements_unlocked}</span>
 ...
 <span className={`text-[10px] font-semibold ${TIER_COLORS[ach.tier] ||'text-zinc-500'}`}>
 {ach.tier}
 </span>
 </div>
 ))}

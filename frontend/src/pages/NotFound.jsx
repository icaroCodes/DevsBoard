...
export default function NotFound() {
 ...
 {}
 <div 
 className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 select-none font-semibold text-[45vw] md:text-[38vw] leading-none z-0 tracking-tighter ${

...
function MobileTaskRow({ id, task, onTap }) {
 ...
 <span className="px-1.5 py-0.5 rounded bg-white/5 text-[9.5px] text-[#86868B] font-bold tracking-tight">
...
'Criar rotina'
 ...
 className={`px-1 py-2.5 rounded-[10px] text-[10.5px] font-bold tracking-tight transition-all border text-center leading-tight ${
 active

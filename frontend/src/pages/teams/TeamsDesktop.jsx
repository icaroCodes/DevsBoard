...
export default function Teams() {
 ...
 disabled={inviting}
 className="w-full h-14 rounded-[20px] bg-white text-black text-[14px] font-semibold hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50 flex items-center justify-center gap-2 shadow-xl shadow-white/5"
 >
 ...
 <label className="text-[11px] font-semibold text-[#86868B] ml-1">Link gerado</label>
 ...
 {inviteMode ==='username' && (
 <div className="space-y-2">
 <label className="text-[11px] font-semibold text-[#86868B] ml-1">@Username</label>
 <div className="relative">
 ...
 className="flex-1 h-14 rounded-[20px] bg-white text-black text-[14px] font-semibold hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50 flex items-center justify-center gap-2 shadow-xl shadow-white/5"
 >
 ...
 <span className="text-[14px] font-bold">Painel Geral</span>
 </button>
 ...
 <div className={`px-2 py-0.5 rounded-md text-[9px] font-semibold ${team.type ==='family' ?'bg-pink-500/20 text-pink-400' :'bg-[#0A84FF]/20 text-[#0A84FF]'
 }`}>
 ...
 <span className="text-sm font-semibold text-zinc-300">{member.user?.name?.[0]?.toUpperCase() ||'?'}</span>
 </div>
 )}
 ...
 <span className="text-[9px] bg-white text-black px-1.5 py-0.5 rounded font-semibold tracking-tighter">EU</span>
 )}
 </div>
 ...
 <span className="text-[10px] sm:text-[11px] font-bold tracking-normal">
 ...
 <span className={`inline-flex items-center justify-center px-1.5 min-w-[20px] h-[20px] rounded-full text-[10px] font-semibold border ${activeTab === tab.id
 ...
 <span className={`shrink-0 text-[9px] font-semibold px-2 py-0.5 rounded-md border ${team.my_role ==='owner'
 ...
 <span className="text-[8px] font-semibold text-[#86868B]">+{team.member_count - 4}</span>
 </div>
 )}
 </div>
 ...
 <span className="text-sm font-semibold text-white/50">{req.user?.name?.[0]}</span>
 )}
 </div>
 <div>
 ...
 <span className="text-[10px] font-semibold text-[#86868B]">Detalhes da Alteração</span>
 <div className="px-2 py-0.5 rounded bg-[#0A84FF]/10 text-[#0A84FF] text-[9px] font-semibold">
 ...
 {inbox.length > 0 && (
 <h3 className="text-[14px] font-semibold text-[#86868B] tracking-normal px-1 mb-3">
 ...
 <span className={`text-[11px] px-3 py-1 rounded-full font-bold tracking-normal ${inv.status ==='pending' ?'bg-amber-500/10 text-amber-400' :
...
'bg-red-500/10 text-red-400'
 ...
 <div className="space-y-4">
 <label className="text-[13px] font-semibold text-[#86868B] ml-1">Escolha o Tipo de Grupo</label>
 ...
 { }
 <div className="space-y-2">
 <label className="text-[13px] font-semibold text-[#86868B] ml-1">Nome do Grupo</label>
 <input
 type="text"
 value={newTeam.name}
 ...
 className="w-full h-16 rounded-[24px] bg-white text-black text-[16px] font-semibold hover:scale-[1.01] active:scale-95 transition-all disabled:opacity-50 shadow-2xl disabled:pointer-events-none"
 >

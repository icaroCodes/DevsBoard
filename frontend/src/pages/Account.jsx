      ...
      {stats && (
        <section className="bg-[var(--db-surface)] border border-[var(--db-border)] rounded-3xl p-5 sm:p-6 shadow-xl space-y-5">
          <div className="text-center py-3">
            ...
            <p className="text-5xl sm:text-6xl font-black tracking-tighter text-[var(--db-text)]">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-[var(--db-bg-secondary)] rounded-2xl p-4 text-center">
              ...
              <p className="text-2xl font-black text-[var(--db-text)]">{stats.currentStreak}</p>
            ...
            <div className="bg-[var(--db-bg-secondary)] rounded-2xl p-4 text-center">
              ...
              <p className="text-2xl font-black text-[var(--db-text)]">{stats.longestStreak}</p>
            ...
            <div className="bg-[var(--db-bg-secondary)] rounded-2xl p-4 text-center">
              ...
              <p className="text-2xl font-black text-[var(--db-text)]">{stats.accountAgeDays}</p>

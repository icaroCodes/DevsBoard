...
export default function Finances() {
 ...
 <h3 className="text-[12px] font-bold text-[#F5F5F7] tracking-normal">Repetições Automáticas</h3>
 </div>
 ...
 className={`flex-1 py-1.5 rounded-[8px] text-[11px] font-bold tracking-tight transition-all ${form.recurrence_interval === int
 ...
 className={`py-2 px-1 rounded-[12px] text-[11px] font-bold tracking-tight transition-all duration-200 border ${form.category === c

...
function MobileGoalCard({ item, onTap, onAddAmount, isOverlay = false }) {
 ...
 <span className="px-1.5 py-0.5 rounded bg-white/[0.05] text-[9.5px] text-[#86868B] font-bold tracking-tight">
 {typeLabel}
 </span>
 </div>
...
function YearAccordion({
 ...
 {isCurrent && (
 <span className="shrink-0 px-1.5 py-0.5 rounded-[5px] bg-[#8E9C78]/10 text-[#8E9C78] text-[9.5px] font-bold tracking-normal">
 Atual
 </span>
 )}
 </div>
...
function FreeZone({ goals, onTap, onAddAmount }) {
 ...
 <p className="text-[10.5px] font-bold tracking-normal text-[#86868B]">
 Avulsas
 </p>
...
'-apple-system, BlinkMacSystemFont,"SF Pro Text","Segoe UI", Roboto, sans-serif',
 ...
 {y.value === currentYear && (
 <span className="text-[10px] font-bold tracking-normal text-[#8E9C78]">
 Atual
 </span>
 )}
 </button>

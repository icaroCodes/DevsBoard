...
function AchievementCard({ achievement, index }) {
 ...
 {}
 <span
 className="px-2 py-0.5 rounded-full text-[8px] sm:text-[9px] font-semibold tracking-normal"
 style={{
 ...
 {}
 {!isHidden && (
 <span className="px-2 py-0.5 rounded-full text-[8px] sm:text-[9px] font-semibold tracking-normal bg-white/[0.03] text-white/20">
 ...
 <span className="text-[9px] font-semibold tracking-normal text-zinc-700">Progresso</span>
 <span className="text-[9px] font-semibold text-zinc-600">{progress}%</span>
 </div>
...
function TierCard({ tierKey, unlocked, total }) {
 ...
 <p
 className="text-[9px] sm:text-[10px] font-semibold mb-2 sm:mb-3"
...
export default function Achievements() {
 ...
 <span className="text-[64px] sm:text-[88px] font-semibold text-white leading-none tracking-tighter">
 {data.stats.unlocked}
 </span>
 ...
 <p className="text-[10px] sm:text-[12px] font-semibold text-white/30 ml-1">
 ...
 <span className="text-[10px] font-semibold text-white/20">Progresso Geral</span>
 <span className="text-[16px] font-semibold text-[#FFD700] tracking-tighter">{data.stats.percentage}%</span>
 </div>

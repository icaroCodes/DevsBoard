    ...
    <div className="px-5 py-8 pb-32">
      ...
      {data && (
        <div className="p-8 bg-[#202020] rounded-[40px] border border-white/[0.03] mb-8">
          ...
          <p className="text-[11px] font-black uppercase tracking-[0.2em] text-white/30 mb-8">
            Troféus Desbloqueados
          </p>

          <div className="flex justify-between items-end mb-3">
            <span className="text-[11px] font-black uppercase tracking-wider text-white/20">Progresso Geral</span>
            <span className="text-[16px] font-black text-[#FFD700]">{data.stats.percentage}%</span>
          </div>
              ...
              return (
                ...
                >
                  <img 
                    ...
                    alt={tier.label}
                  />
                  <span className="text-[9px] font-black tracking-[0.2em] mb-1" style={{ color: isLocked ? '#3a3a3c' : tier.color }}>
                    {tier.label}
                  </span>

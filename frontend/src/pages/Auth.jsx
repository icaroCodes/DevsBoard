...
const translations = {
  pt: {
    ...
    googleLoading: "Conectando com Google…",
    ...
    <div style={s.page}>
      ...
      >
        ...
        <a
          ...
          style={{ ...s.btnGithub, opacity: oauthLoading && oauthLoading !== 'github' ? 0.6 : 1, pointerEvents: oauthLoading ? 'none' : 'auto' }}
        >
          {oauthLoading === 'github' ? (
            <span style={s.spinner} aria-hidden="true">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
        ...
        <a
          ...
          className="auth-github"
          style={{ ...s.btnGithub, marginTop: -8, opacity: oauthLoading && oauthLoading !== 'google' ? 0.6 : 1, pointerEvents: oauthLoading ? 'none' : 'auto' }}
        >
          {oauthLoading === 'google' ? (
            <span style={s.spinner} aria-hidden="true">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
          ...
          <span>{oauthLoading === 'google' ? t.googleLoading : t.googleBtn}</span>
        </a>

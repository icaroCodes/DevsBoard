        ...
        {activeSection === 'main' ? (
          ...
          >
            ...
            <div className="space-y-3">
              <p className="text-[11px] font-black uppercase tracking-[0.2em] text-white/20 ml-2 mb-1">Preferências</p>
              <NavigationItem 
                icon={User} 
                label="Perfil" 
            ...
            <div className="space-y-3">
              <p className="text-[11px] font-black uppercase tracking-[0.2em] text-white/20 ml-2 mb-1">Sistema</p>
              <button
                onClick={() => {
                  confirm({
                    title: "Sair?",
          ...
          >
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                <label className="text-[11px] font-black uppercase tracking-wider text-white/40 ml-2">Nome de Exibição</label>
                <input
                  type="text"
                  value={form.name}
              ...
              <button
                ...
                disabled={saving}
                className="w-full bg-[var(--db-accent)] text-black py-5 rounded-[24px] font-black text-[15px] shadow-lg shadow-[var(--db-accent)]/10"
              >
          ...
          >
            ...
            <p className="text-[11px] font-black uppercase tracking-wider text-white/40 ml-2 mb-4">Tema do Sistema</p>
            ...
            <p className="text-[11px] font-black uppercase tracking-wider text-white/40 ml-2 mb-4">Papel de Parede</p>
            <div className="bg-[#202020] p-6 rounded-[32px] border border-white/5 space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center px-1">
                  <span className="text-[11px] font-black text-white/40 uppercase">Opacidade</span>

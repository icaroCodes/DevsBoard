...
export default function Settings() {
 ...
 <span className="text-[13px] font-bold text-[var(--db-accent)]">Preferências</span>
 </div>
 ...
 <label className="text-[13px] font-bold text-[var(--db-text-2)] ml-1 tracking-normal">
 Nome de Exibição
 </label>
 <input
 type="text"
 ...
 {}
 <div className="absolute top-4 left-4 flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-black/40 backdrop-blur-sm border border-white/10 text-white/80 text-[11px] font-bold tracking-normal">
 ...
 <label className="text-[13px] font-bold text-[var(--db-text-2)] tracking-normal">Intensidade</label>
 ...
 <div>
 <label className="block text-[11px] font-bold text-[var(--db-text-3)] tracking-normal mb-1.5">Nome da música</label>
 <input
 type="text"
 value={audioName}
 ...
 <div>
 <label className="block text-[11px] font-bold text-[var(--db-text-3)] tracking-normal mb-1.5">Artista</label>
 <input
 type="text"
 value={audioArtist}
 ...
 <p className="text-6xl font-semibold tracking-tighter text-[var(--db-text)]">
 ...
 <p className="text-2xl font-semibold text-[var(--db-text)]">{usageStats.currentStreak}</p>
 ...
 <p className="text-2xl font-semibold text-[var(--db-text)]">{usageStats.longestStreak}</p>
 ...
 <p className="text-2xl font-semibold text-[var(--db-text)]">{usageStats.accountAgeDays}</p>

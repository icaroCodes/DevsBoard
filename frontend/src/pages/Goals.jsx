...
function FreeGoalsZone({
 ...
 <p className="text-[12px] font-bold tracking-normal text-[#86868B]">
 Metas avulsas
 </p>
...
export default function Goals() {
 ...
 <div>
 <label className="block text-[13px] font-medium text-[#86868B] mb-2 tracking-normal">O que você quer conquistar?</label>
 <input
 type="text"
 value={form.name}
 ...
 <div>
 <label className="block text-[13px] font-medium text-[#86868B] mb-3 tracking-normal">Como você quer medir?</label>
 ...
 <div>
 <label className="block text-[13px] font-medium text-[#86868B] mb-3 tracking-normal">Até quando você quer conseguir?</label>
 <div className="flex p-1 bg-[#2C2C2E] rounded-[16px] border border-white/[0.04] relative">
 ...
 <label className="block text-[13px] font-medium text-[#86868B] mb-2 tracking-normal">Quanto dinheiro você precisa juntar? (R$)</label>

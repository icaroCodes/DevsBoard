    ...
    <div className="min-h-screen font-[Poppins,sans-serif] bg-[#121214] text-zinc-100 pb-20">
      ...
      <div className="px-4 py-8">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex items-center gap-2 mt-5 text-[12px] text-[#86868B] font-semibold uppercase tracking-wider bg-white/5 px-4 py-2 rounded-full">
            <Calendar size={14} />
            Desde {memberSince}
          </div>
        ...
        {p.stats && (
          <div className="mt-10 space-y-3">
            <h2 className="text-[13px] font-bold text-[#86868B] uppercase tracking-wider px-1 mb-3">Estatísticas</h2>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="bg-[#1C1C1E] rounded-2xl p-4 border border-white/[0.04] relative overflow-hidden group">
                ...
                <div className="text-[10px] font-bold text-orange-500 uppercase tracking-widest mb-1.5 flex items-center gap-1.5 relative z-10">
            ...
            <div className="bg-[#1C1C1E] rounded-2xl p-4 border border-white/[0.04]">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-baseline gap-1">
                  <span className="text-xl font-black text-white tracking-tight">{p.stats.achievements_unlocked}</span>
        ...
        {p.stats?.top_achievements?.length > 0 && (
          <div className="mt-10">
            <h2 className="text-[13px] font-bold text-[#86868B] uppercase tracking-wider px-1 mb-3">Top Conquistas</h2>
              ...
              {p.stats.top_achievements.map((ach) => (
                <div key={ach.slug} className="bg-[#1C1C1E] rounded-2xl p-4 border border-white/[0.04] flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className={`text-[10px] font-black uppercase tracking-widest mt-1 ${TIER_COLORS[ach.tier] || 'text-zinc-500'}`}>
                      {ach.tier}
                    </div>
                  </div>
                </div>

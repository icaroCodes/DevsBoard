...
'-apple-system, BlinkMacSystemFont,"SF Pro Text","Segoe UI", Roboto, sans-serif',
 ...
 <span className="text-[10.5px] font-semibold tracking-normal">
 Entrou
 </span>
 </div>
 ...
 <h3 className="text-[11px] font-bold text-[#86868B] tracking-normal">
 ...
 <p className="text-[11px] text-[#86868B] tracking-normal font-semibold">
 ...
 className={`flex-1 py-1.5 rounded-[7px] text-[10.5px] font-bold tracking-tight transition-all ${
 ...
 className={`px-1.5 py-2.5 rounded-[10px] text-[10.5px] font-bold tracking-tight transition-all border text-center leading-tight ${
 active

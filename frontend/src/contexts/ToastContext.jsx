...
function ToastItem({ message, type, onClose }) {
 ...
 className={`solid-modal pointer-events-auto relative overflow-hidden flex items-center gap-3.5 px-4 py-4 rounded-[20px] border border-white/[0.08] bg-[#202020]/80 backdrop-blur-xl shadow-[0_10px_30px_rgba(0,0,0,0.3)] min-w-[300px] max-w-md`}
